...
This list provides access to places mentioned in the Michiele text and the notes on each plant. Please note that the indices have not yet been completely finalized or standardized. Also, the encoding of place names in the text is not yet complete. 
...
## [Monte Corno](https://www.geonames.org/3178053/monte-corno.html)
