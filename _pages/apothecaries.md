...
But *Materia Medica* was the absolute protagonist: preserved in the storerooms, in the jars and vessels on display in the shop, and as a subject of conversation. At the Testa d'oro pharmacy of Rialto (its golden sign still hangs over Rialto bridge) <img src="https://upload.wikimedia.org/wikipedia/commons/8/86/Testadoro.jpg"/>, the magnificently illustrated herbal called 'Codice Rinio [but Roccabonella]' was on display for the use of experts, but also for the curious who wanted to see and know something more about plants.
